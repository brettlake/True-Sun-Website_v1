    ...
    <div className="w-full bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 p-2 md:p-3 rounded-none vintage-shadow transform transition-all hover:border-zinc-700">
      <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2">
        <input 
          ...
          className="flex-1 bg-[#1a1a1a] text-white placeholder-zinc-500 px-6 py-4 focus:outline-none focus:ring-1 focus:ring-[#FFC400] uppercase font-bold tracking-wider text-sm md:text-base border-none w-full disabled:opacity-50"
        />
        <Button 
          type="submit" 
          variant="primary" 
